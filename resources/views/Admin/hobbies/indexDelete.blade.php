...
@section('title', 'Hobbie')
@section('sub-title','My Deleted Hobbie')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    ...
                    <h6 class="modal-title">Delete Hobbie</h6>
                </div>

                <div class="modal-body">
                    <h6 class="text-semibold">Delete Hobbie</h6>
                    <p>Are you sure want to delte this Hobbie Which tile is <b>{{$data->title}} </b></p>
                ...
                <div class="modal-footer">
                    ...
                    <a href="/dashboard/Hobbie/pdelete/{{$data->id}}" class="btn btn-danger">Delete</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">×</button>
                    <h6 class="modal-title">Restore Hobbie</h6>
                </div>

                <div class="modal-body">
                    <h6 class="text-semibold">Restore Hobbie</h6>
                ...
                <div class="modal-footer">
                    ...
                    <!-- <button type="button" class="btn btn-danger">Save changes</button> -->
                    <a href="/dashboard/Hobbie/restore/{{$data->id}}" class="btn btn-success">Restore</a>
                </div>
            </div>
        </div>
    </div>
